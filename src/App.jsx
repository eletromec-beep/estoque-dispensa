    ...
    return (
      <div className="max-w-sm mx-auto flex flex-col gap-4 py-8 px-4">
        <div className="flex flex-col items-center gap-3 mb-4">
          ...
          />
          <h1 className="text-xl font-semibold text-gray-800 text-center">Dispensa Salão do Reino</h1>
          <p className="text-sm font-medium text-gray-500 text-center -mt-2">Cong. Santana do Ipanema AL</p>
